# Storybook Addon Scheme toggler
Storybook Scheme Toggler enables seamless switching between light, dark, and auto (browser-synced) themes directly from the Storybook toolbar.
